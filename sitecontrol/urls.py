...
urlpatterns = [
    ...
    path("activation-requests/", views_registration.activation_request_list, name="activation_request_list"),
    path("activation-requests/<uuid:pk>/", views_registration.activation_request_detail, name="activation_request_detail"),
